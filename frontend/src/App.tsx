...
const QuestionnaireVisualizationPage = React.lazy(() => import('./pages/analytics/QuestionnaireVisualizationPage').then(module => ({ default: module.QuestionnaireVisualizationPage })));
